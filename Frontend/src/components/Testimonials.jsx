...
const testimonials = [
  ...
  {
    quote: "For anyone searching for a business centre in Abu Dhabi, Aegis Coworking in ADGM is a very convenient option. The location at Addax Tower and professional setup have been excellent for our business.",
    name: "Fatima S.",
    role: "Business Owner",
    initials: "FS"
  },
  ...
  {
    quote: "The meeting room at this ADGM coworking space is modern and professional. The location makes client meetings convenient, and the overall experience has been excellent.",
    name: "Nadia T.",
  ...
  {
    quote: "The dedicated desk in Abu Dhabi is a great option if you're looking for a cheap dedicated desk in ADGM. The workspace is comfortable, professional, and available whenever I need it.",
    name: "Yusuf M.",
  ...
  {
    quote: "The coworking day pass at Aegis is a convenient way to use a professional workspace in Abu Dhabi without a long-term commitment. The daily coworking pass is a great option for freelancers and remote workers.",
    name: "Omar S.",
    role: "Independent Consultant",
    initials: "OS"
  },
  {
    quote: "I needed a cheap coworking space in Abu Dhabi with a professional location. Aegis Coworking in Addax Tower on Al Reem Island gave me exactly that, with a comfortable workspace and useful facilities.",
    name: "Rania M.",
  ...
  {
    quote: "For businesses looking for a low cost office in ADGM, Aegis provides flexible office space and a professional setting. The team made the setup process very easy.",
    name: "Claire D.",
  ...
  {
    quote: "For anyone searching for an ADGM business centre, Aegis Coworking offers a professional serviced office in ADGM with flexible options. The team has been responsive and easy to work with.",
    name: "Elena V.",
