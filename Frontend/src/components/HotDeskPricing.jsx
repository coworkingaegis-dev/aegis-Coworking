...
function HotDeskPricing() {
  ...
  and the wider coworking community. </p>
       <p className="desk-desc">   Book your ADGM Coworking Space with Aegis Coworking that sits in office 3812, Addax Tower, Al Reem Island.
