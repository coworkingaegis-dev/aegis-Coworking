...
function Home() {
  ...
  <meta
    name="description"
    content="Affordable Coworking space in ADGM starting from AED 1000, Addax Tower, Abu Dhabi. Private & virtual offices, meeting rooms, day passes — book a tour today."
  />
