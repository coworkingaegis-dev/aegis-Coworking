...
//     <div className="App">
//       <Helmet>
//         <title>Office Spaces in ADGM | Dedicated Desks from AED 1150/month | Aegis Coworking</title>
//         <meta
//           name="description"
...
//   },
//   {
//     q: "Is 24/7 access really included?",
...
//     <div className="App">
//       <Helmet>
//         <title>Office Spaces in ADGM | Aegis Coworking</title>
//         <meta
//           name="description"
//           content="Flexible office spaces in ADGM, Addax Tower. Dedicated desks from AED 1150/month with 24/7 access. Private, secure workspace for individuals and teams in Abu Dhabi's financial district."
//         />
...
function OfficeSpaces() {
  ...
  {JSON.stringify({
    ...
    "offers": {
      ...
      <PageHero
        title="OFFICE SPACES IN ADGM"
        subtitle="PRIVATE DESK | 24/7 ACCESS | FLEXIBLE MEMBERSHIP in ADGM"
      />
      <DeskPricing />
      <NearbyFacilities />
      <Amenities title="ADGM AMENITIES" />
