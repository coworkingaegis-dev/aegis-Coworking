...
function Pricing() {
  ...
  return (
    <>
      <Helmet>
        <title>Pricing in ADGM | Aegis Coworking</title>
        <meta
          name="description"
          content="Transparent coworking pricing in ADGM, Abu Dhabi. Hot desks from AED 1,000, dedicated desks from AED 1,150, private offices from AED 4,500. Get a quote today."
        />
